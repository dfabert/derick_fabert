const projects = [
    ...
    },
    {
      id: 5,
      name:  "Eat The Burger",
      description: "This is an app that allows the user to keep track of the burgers he or she would like to eat. When they eat the burger, they can hit devour and the burger will move to the other side. Future development will include the option to delete the burgers and give them a rating.",
