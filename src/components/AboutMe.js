     ...
     <div class="container-sm"  class="d-flex justify-content-center">
        <div class="row">
          ...
          <div class='col-sm-3' style="padding: 20px;">
            <div class = 'links'>
              <a class="btn btn-primary" style="width: 115px; margin-top: 40px;"  href="https://dfabert.github.io/DerickFabert/assets/Glen%20Derick%20Fabert%20Resume.pdf" target="_blank" role="button" />Resume</a>
            </div>
            <div class = 'links'>
              <a href="https://github.com/dfabert" target="_blank"><img className='sidePhoto' src="assets/Photos/GitHub-Mark.png" alt="LinkedIn Logo" /></a>
            </div>
            <div class = 'links'>
              <a href="https://www.linkedin.com/in/derick-fabert" target="_blank"><img className='sidePhoto' src="assets/Photos/LI-In-Bug.png" alt="LinkedIn Logo" /></a>
            </div>
            <div class = 'links'>
              <a href="https://twitter.com/derick_fabert?lang=en" target="_blank"><img className='sidePhoto' src="assets/Photos/Twitter_Logo_WhiteOnBlue.png" alt="TwitterLogo" /></a>
            </div>
          </div>
        </div>
    );
