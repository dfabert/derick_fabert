    ...
    <div class="container-sm">
      <div class="row">
        ...
        <div class='col-sm-3' style={{padding: "20px"}}>
          <div class = 'links'>
            <a class="btn btn-primary" style={{width: "115px", marginTop: "20px"}}  href="https://dfabert.github.io/DerickFabert/assets/Glen%20Derick%20Fabert%20Resume.pdf" target="_blank" rel='noreferrer' role="button">Resume</a>
          </div>
          <div class = 'links'>
